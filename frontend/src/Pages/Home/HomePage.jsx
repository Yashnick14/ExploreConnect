...
import { useAuthStore } from "@/store/Auth/auth"; // ✅ assuming you have an auth store
...
const HomePage = () => {
  ...
  const { user } = useAuthStore(); // ✅ logged-in user (if available)
  ...
  useEffect(() => {
    // ✅ Pass user context into fetchLatestPlaces
    fetchLatestPlaces(user?.role === "admin", user?._id);
  }, [fetchLatestPlaces, user]);
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-4">Interagency & Site Passes</h2>
          <p className="text-medium text-gray-100 mb-6">
